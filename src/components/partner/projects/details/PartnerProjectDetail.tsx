...
import { PartnerProjectDetailsCard } from "./PartnerProjectDetailsCard";
import { PartnerProjectBudgetCard } from "./PartnerProjectBudgetCard";
import { PartnerProjectDetailsTabs } from "./PartnerProjectDetailsTabs";
...
export const PartnerProjectDetail = ({ id }: PartnerProjectDetailProps) => {
  ...
  const {
    ...
    queryFn: async () => {
      const result = await api.partner.projects.getById(id);
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <PartnerProjectDetailsCard project={project} />
        <PartnerProjectBudgetCard
          project={project}
      ...
      <PartnerProjectDetailsTabs projectId={id} />
    </div>
  );
};

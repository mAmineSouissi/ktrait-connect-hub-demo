...
interface ClientDocumentUpdateFormProps {
  className?: string;
...
export const ClientDocumentUpdateForm: React.FC<ClientDocumentUpdateFormProps> = ({
  className,
  updateDocument,
  ...
  const handleChange = (field: keyof UpdateDocumentRequest, value: string) => {
    ...
    <form onSubmit={handleSubmit} className={cn("space-y-4", className)}>
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value) => handleChange("status", value as "en_attente" | "validé" | "rejeté")}
          disabled={isUpdatePending || isUploading}
        >
          <SelectTrigger>
            <SelectValue />
          ...
          {selectedFile ? (
            ...
            <>
              ...
              <p className="text-sm text-muted-foreground">
                Cliquez ou glissez un fichier ici pour remplacer
              </p>
      ...
      <div className="flex justify-end gap-2 pt-4">
        ...
        >
          ...
          {isUploading ? "Upload..." : "Mettre à jour"}
        </Button>
      </div>
    </form>
  );

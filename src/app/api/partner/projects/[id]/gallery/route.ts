...
import type { ProjectGalleryRow } from "@/types/supabase-database.types";
...
/**
 * GET /api/partner/projects/[id]/gallery
 * List all gallery items for a project (read-only, only if partner is assigned)
 */

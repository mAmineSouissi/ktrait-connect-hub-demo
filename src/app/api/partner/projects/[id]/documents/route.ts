...
import type { DocumentRow } from "@/types/supabase-database.types";
...
/**
 * GET /api/partner/projects/[id]/documents
 * List all documents for a project (read-only, only if partner is assigned)
 */
export async function GET(
  ...
  try {
    ...
    const { data: documents, error } = result as {
      data: (DocumentRow & {

...
import type { ProjectTaskRow } from "@/types/supabase-database.types";
...
/**
 * GET /api/partner/projects/[id]/tasks
 * List all tasks for a project (read-only, only if partner is assigned)
 */

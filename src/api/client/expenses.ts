...
const API_BASE = "/api/client/expenses";
...
export const expenses = {
  ...
  /**
   * Get expense details by ID (for current client only)
   */
  ...
  /**
   * Create a new expense (project must belong to current client)
   */
  ...
  /**
   * Update expense by ID (only if it belongs to current client's project)
   */
  async update(
    id: string,
  ...
  /**
   * Delete expense by ID (only if it belongs to current client's project)
   */

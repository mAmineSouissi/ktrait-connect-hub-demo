...
export const gallery = {
  /**
   * List all gallery items for a project (for current client only)
   */
  ...
  /**
   * Get a single gallery item by ID (for current client only)
   */
  async getById(
    projectId: string,
    galleryId: string
  ...
  /**
   * Create a new gallery item for a project (project must belong to current client)
   */
  async create(
    projectId: string,
  ...
  /**
   * Update gallery item by ID (only if it belongs to current client's project)
   */
  async update(
    projectId: string,
    galleryId: string,
  ...
  /**
   * Delete gallery item by ID (only if it belongs to current client's project)
   */
  async delete(
    projectId: string,
    galleryId: string
